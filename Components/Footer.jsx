...
const Footer = () => {
  return (
    <footer className="bg-orange-800 text-white py-12 border-t-2 border-slate-400">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <Link className="italic text-3xl text-white font-bold" href="/index.html ">
          ...
          <div>
            ...
            <p className="text-sm"><span className="text-xl"><i
              className="fa-solid fa-location-dot text-red-600"></i></span>Danapur usri road khagol</p>
            <p className="mt-2"><i className="fa-solid fa-phone text-red-600"></i><Link href="tel:+918292236605"
              className="font-semibold hover:underline">+91 8292236605</Link></p>
            <p className="mt-2"><i className="fa-solid fa-phone text-red-600"></i> <Link href="tel:+919905194346"
              className="font-semibold hover:underline">+919905194346</Link></p>
            <p><i className="fa-solid fa-envelope text-red-600"></i><Link
